...
function [outputStruct, outputFileName] = formattedBIN(folder_path, saving)
    ...
    % JSC edit - change later - The first file in a list is much larger
    % than the rest and causing memory issues. Changing to start at 2 to
    % work through all of the other files.
    for this_file = 3:height(file_list)
